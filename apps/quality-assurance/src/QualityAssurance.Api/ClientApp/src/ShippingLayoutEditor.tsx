...
export const SHIPPING_COLUMN_METADATA: Record<ShippingLayoutColumnKey, ColumnMetadata> = {
  status: { label: 'Status', minimumWidth: 28, maximumWidth: 480, required: true },
  salesOrderNumber: { label: 'Sales Order #', minimumWidth: 28, maximumWidth: 480 },
  qaArrivalDate: { label: 'QA Arrival', minimumWidth: 28, maximumWidth: 480 },
  partNumber: { label: 'Part Number', minimumWidth: 28, maximumWidth: 480, required: true },
  purchaseOrderNumber: { label: 'P.O.', minimumWidth: 28, maximumWidth: 480 },
  customer: { label: 'Customer', minimumWidth: 28, maximumWidth: 480 },
  taskType: { label: 'Task Type', minimumWidth: 28, maximumWidth: 480 },
  quantity: { label: 'Quantity', minimumWidth: 28, maximumWidth: 480 },
  dollarValue: { label: 'Dollar Value', minimumWidth: 28, maximumWidth: 480 },
  shipDate: { label: 'Ship Date', minimumWidth: 28, maximumWidth: 480 },
  holdReason: { label: 'Hold Reason', minimumWidth: 28, maximumWidth: 640 },
  sourceRequestedDate: { label: 'Source Requested', minimumWidth: 28, maximumWidth: 480 },
  nextAction: { label: 'Action', minimumWidth: 28, maximumWidth: 640, required: true },
  lastWorkedAt: { label: 'Last Worked', minimumWidth: 28, maximumWidth: 480 },
  comments: { label: 'Comments', minimumWidth: 28, maximumWidth: 640 },
  assignment: { label: 'Assigned To', minimumWidth: 28, maximumWidth: 480 },
  queueAge: { label: 'Queue Age', minimumWidth: 28, maximumWidth: 480 },
}
