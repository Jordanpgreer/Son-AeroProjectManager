...
public sealed class EstimatingAccessStoreTests
{
    ...
    public async Task Access_preview_returns_to_configured_permanent_portal_url()
    {
        ...
        var configuration = new ConfigurationBuilder()
            ...
            .Build();
        var service = new EstimatingAccessPreviewService(fixture.Db, configuration);
    ...
    public async Task Permanent_module_request_overrides_a_preserved_legacy_portal_url()
    {
        ...
        context.Request.Host = new HostString("estimating.hub.son4l.local");

        var url = new EstimatingAccessPreviewService(fixture.Db, configuration).GetReturnToAdminUrl(context);
    ...
    public async Task Legacy_module_request_keeps_legacy_portal_url_for_rollback()
    {
        ...
        context.Request.Host = new HostString("SON-IIS2", 5160);
    ...
    public async Task Https_pilot_request_uses_pilot_port_even_with_permanent_portal_configuration()
    {
        ...
        var context = new DefaultHttpContext();
        context.Request.Scheme = "https";
        context.Request.Host = new HostString("SON-IIS2", 6160);
    ...
    public async Task Arbitrary_request_host_is_never_used_in_preview_return_url()
    {
        ...
        var context = new DefaultHttpContext();
        context.Request.Scheme = "https";
        context.Request.Host = new HostString("estimating.hub.son4l.local.attacker.example");

        var url = new EstimatingAccessPreviewService(fixture.Db, configuration).GetReturnToAdminUrl(context);

        Assert.Equal("https://hub.son4l.local/#/admin/access", url);
        Assert.Throws<InvalidOperationException>(() =>
            new EstimatingAccessPreviewService(fixture.Db, new ConfigurationBuilder().Build())
