...
namespace ProjectTracker.Api.Data.Migrations
{
    ...
    [Migration("20260819193332_AddOperationScheduleConfirmations")]
    partial class AddOperationScheduleConfirmations
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ProjectTracker.Api.Models.Project", b =>
                {
                    ...
                    b.Property<bool>("ImportNeedsCompletion")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bit")
            ...
            modelBuilder.Entity("ProjectTracker.Api.Models.PushSubscriptionRecord", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ProjectTracker.Api.Models.UserNotification", b =>
                {
                    ...
                    b.HasIndex("RecipientUserId", "ProjectTaskId", "Kind", "ScheduledDate")
                        .IsUnique()
            ...
            modelBuilder.Entity("SonAero.Platform.Security.AccessPreviewSessionRecord", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");

                    b.Property<string>("AdministratorAccountName")
                        .IsRequired()
                        .HasMaxLength(160)
                        .HasColumnType("nvarchar(160)");
                    ...
                    b.Property<DateTimeOffset>("LaunchExpiresAt")
                        .HasColumnType("datetimeoffset");
                    ...
                    b.HasIndex("ApplicationId", "SessionExpiresAt");

                    b.ToTable("AccessPreviewSessions", (string)null);
                });
            ...
            modelBuilder.Entity("ProjectTracker.Api.Models.ProjectTask", b =>
                {
                    b.HasOne("ProjectTracker.Api.Models.ProjectTask", "DependencyTask")
