...
public sealed class WorkbookImportServiceTests
{
    ...
    {
        // Candidate locations relative to any ancestor directory. The workbook lives under
        // data/project-tracker/legacy-workbooks in the monorepo layout; the bare filename is
        // kept as a fallback for older/flat layouts.
        var relativeCandidates = new[]
        {
            Path.Combine("data", "project-tracker", "legacy-workbooks", "Project Tracker.xlsm"),
